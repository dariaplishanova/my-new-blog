...
export default function Footer() {
  ...
  return (
    <footer className="mt-8 px-3 text-sm leading-6">
      <div className="border-t border-slate-200 pt-10 pb-10 text-slate-500 sm:flex sm:justify-between">
        <div className="mb-6 sm:mb-0 sm:flex sm:items-center">
          <p>Created {new Date().getFullYear()} Blog</p>
        ...
        <div className="flex space-x-10 text-slate-400">
          <a
            href="https://github.com/dariaplishanova/my-new-blog"
